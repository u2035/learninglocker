...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://sso.2035.university/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://sso.2035.university/oauth2/access_token';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'sso';
  this._userProfileURL = options.userProfileURL || 'https://sso.2035.university/users/me';
