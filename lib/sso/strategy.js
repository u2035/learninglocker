...
var OAuth2Strategy = require('passport-oauth2')
  , util = require('util')
  , uri = require('url')
  , SSOProfile = require('./sso')
  , InternalOAuthError = require('passport-oauth2').InternalOAuthError
  , GooglePlusAPIError = require('./googleplusapierror')
...
function Strategy(options, verify) {
  options = options || {};
  options.authorizationURL = options.authorizationURL || 'https://sso.university2035.ru/oauth2/authorize';
  options.tokenURL = options.tokenURL || 'https://sso.university2035.ru/oauth2/access_token';

  OAuth2Strategy.call(this, options, verify);
  this.name = 'sso';
  this._userProfileURL = options.userProfileURL || 'https://sso.university2035.ru/users/me';
